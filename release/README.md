...
The current artifact manifest is `docs/audits/2026-09-09-remediation/artifact.json`. `RELEASE_AUDIT` can select a different reviewed manifest; the deployment script still requires the exact static release directory and file hashes.
